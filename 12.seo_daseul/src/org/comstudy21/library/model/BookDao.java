...
public class BookDao {
	...
	public BookDao(ArrayList<BookDto> bookdtoList) {
		...
		this.bookdtoList.add(new BookDto(bseq++, "java", "park", "book1","가능"));
		this.bookdtoList.add(new BookDto(bseq++, "python", "chang", "book2","가능"));
		this.bookdtoList.add(new BookDto(bseq++, "oracle", "sung", "book3","가능"));
		this.bookdtoList.add(new BookDto(bseq++, "ondo", "lee", "book4","가능"));
	}
